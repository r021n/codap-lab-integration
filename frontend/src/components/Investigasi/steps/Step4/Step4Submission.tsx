          ...
          <CardContent className="pt-2">
            ...
            >
              ...
              <Button
                ...
                className="h-11 px-8 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold shadow-lg shadow-emerald-500/20"
              >
                {isUploading ? (
                  <>
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-right">
                        <Button
                          ...
                          className="rounded-xl border-border/20 hover:bg-emerald-600 hover:text-white transition-all"
                        >
