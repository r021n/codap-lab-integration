        ...
        <div className="p-3 border-b border-border/20 bg-background/90 sticky top-0 backdrop-blur-sm z-10">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={onBack}
                className="px-2.5 py-1.5 text-[10px] md:text-xs font-semibold rounded-lg border-2 border-slate-200 text-slate-600 hover:bg-slate-50 active:scale-95 transition-all duration-150"
